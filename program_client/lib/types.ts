...
export const decodeTicketMetadata = (decoded: Decoded): TicketMetadata => ({
    ...
    limitedEdition: decoded["limited_edition"] as string,
    additionalBenefits: decoded["additional_benefits"] as string,
    rating: decoded["rating"] as string,
    schedule: decoded["schedule"] as string,
    organizer: decoded["organizer"] as string,
