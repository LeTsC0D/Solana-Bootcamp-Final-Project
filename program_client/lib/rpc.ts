...
export enum ConcertTicketNftInstruction {
/**
 * Accounts:
 ...
 *
 * Data:
 * - ticket_type: {@link string} 
 * - currency: {@link string} 
 * - limited_edition: {@link string} 
 * - additional_benefits: {@link string} 
 * - rating: {@link string} 
 * - schedule: {@link string} 
 * - organizer: {@link string} 
...
export const mint = (args: MintArgs): TransactionInstruction => {
    const data = serialize(
        ...
        {
            id: ConcertTicketNftInstruction.Mint,
            ticket_type: args.ticketType,
            currency: args.currency,
            limited_edition: args.limitedEdition,
            additional_benefits: args.additionalBenefits,
            rating: args.rating,
...
export const transfer = (args: TransferArgs): TransactionInstruction => {
    const data = serialize(
        ...
        {
            id: ConcertTicketNftInstruction.Transfer,
        }
    );
...
export const burn = (args: BurnArgs): TransactionInstruction => {
    const data = serialize(
        ...
        {
            id: ConcertTicketNftInstruction.Burn,
        }
    );
